const { Document, Packer, Paragraph, TextRun, AlignmentType, UnderlineType, TextAlignment } = require('docx');
const fs = require('fs');
        ...
        sections: [
            {
                children: [
                    ...
                    new Paragraph({
                        children: [
                            new TextRun("Dalam rangka mewujudkan manajemen pemerintahan yang efektif, transparan dan akuntabel serta berorientasi pada hasil, yang bertanda tangan di bawah ini:"),
                        ],
